...
if "FAIL" in res.stdout:
    print("❌ Simulation Failed. Aborting flow to prevent bad logic from being synthesized.")
    sys.exit(1)
...
if sta_tool:
    print(f"ℹ️  Using STA tool at: {sta_tool}")
    env = os.environ.copy()
    ...
    print("⚠️ STA Tool not found. Skipping timing.")
